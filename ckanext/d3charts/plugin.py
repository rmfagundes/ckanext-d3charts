...
class D3BaseChart(p.SingletonPlugin):
    ...
    def update_config(self, config):
        ...
        p.toolkit.add_resource('theme/public', 'd3charts')
...
class D3CalendarChart(D3BaseChart):
    ...
    def info(self):
        ...
        info['name'] = 'd3calendarchart'
        info['title'] = 'Calendar Chart'
        info['icon'] = 'calendar'

        return info

    def form_template(self, context, data_dict):
        return 'd3_calendarchart_form.html'
...
class D3HistogramChart(D3BaseChart):
    ...
    def info(self):
        ...
        info['name'] = 'd3histogramchart'
        info['title'] = 'Histogram Chart'
